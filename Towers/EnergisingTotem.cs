...
public class EnergisingTotem : ModPowerTower
{
    ...
    public override int Cost => AllPowersInShopMod.EnergisingTotemCost;
    ...
    public override void ModifyTowerModelForMatch(TowerModel towerModel, GameModel gameModel)
    {
        ...
        towerModel.GetBehavior<RateSupportModel>().multiplier = 1 - AllPowersInShopMod.TotemAttackSpeed;
    ...
    public class TSMThemeEnergisingTotem_OnButtonPress
    {
        ...
        public static bool Prefix(TSMThemeEnergisingTotem __instance, TowerToSimulation tower)
        {
            if (tower.worth > 0)
            {
                ...
                var cost = CostHelper.CostForDifficulty(AllPowersInShopMod.TotemRechargeCost, InGame.instance);
                if (cash < cost)
                {
                    return false;
                }
