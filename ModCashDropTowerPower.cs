...
public abstract class ModCashDropTowerPower : ModPowerTower
{
    protected abstract int Pierce { get; }

    public override string BaseTower => TowerType.PortableLake;

    public override bool DontAddToShop => !AllPowersInShopMod.AllowCashDrop;
    ...
    internal static void OnUpdate()
    {
        ...
        if (towerModel != null && inputManager!.inPlacementMode && towerModel.GetModTower() is ModCashDropTowerPower)
        {
    ...
    internal class InputManager_EnterPlacementMode
    {
        ...
        {
            if (forTowerModel.GetModTower() is ModCashDropTowerPower trackPower)
            {
    ...
    internal class Map_CanPlace
    {
        ...
        {
            if (tm.GetModTower() is ModCashDropTowerPower)
            {
                var map = InGame.instance.UnityToSimulation.simulation.Map;
    ...
    public class Tower_OnDestroy
    {
        ...
        {
            if (__instance.towerModel?.GetModTower() is ModCashDropTowerPower trackPower &&
